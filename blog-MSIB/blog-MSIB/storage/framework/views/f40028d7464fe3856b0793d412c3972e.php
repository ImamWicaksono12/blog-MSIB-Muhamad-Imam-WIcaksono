...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route('posts.update')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group">
            ...
            <input type="file" name="image" class="form-control" value="<?php echo e($post->image); ?>">
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Joki\imam\blog-MSIB-master\resources\views/posts/edit.blade.php ENDPATH**/ ?>